...
if (websiteLive) {
    plotEnrich(enrichedCombinedShared$GO_Biological_Process_2015, showTerms = 20, numChar = 40, y = "Count", orderBy = "Adjusted.P.value", title = "Rnaseh and s9.6 shared genes")
}
